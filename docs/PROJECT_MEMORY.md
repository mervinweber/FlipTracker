...
- Marketplace listings include a structured Language selector. Media defaults to English, manual Language item specifics remain authoritative, and eBay's catalog-safe inventory retry preserves the required Language aspect.
